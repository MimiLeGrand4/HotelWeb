...
namespace ProjetHotel.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Adresse,Téléphone,Email,Description,UrlImage")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Adresse,Téléphone,Email,Description,UrlImage")] Hotel hotel)
        {
            if (id != hotel.Id)
            {
                return NotFound();
