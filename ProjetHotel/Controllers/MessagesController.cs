...
namespace ProjetHotel.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Contenu,DateEnvoi,UtilisateurId")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Contenu,DateEnvoi,UtilisateurId")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
